...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\YashrajD\Documents\Python_Test_Projects\Images_GUI\alexandr-podvalny-n_Jb_d8O43Q-unsplash.jpg")
        
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0,width=1600,height=768)

        frame1= Frame(self.root,bg="#002B53")
        frame1.place(x=560,y=170,width=340,height=450)

        img1=Image.open(r"C:\Users\YashrajD\Documents\Python_Test_Projects\Images_GUI\log1.png")
